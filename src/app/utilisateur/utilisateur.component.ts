  ...
  export class UtilisateurComponent implements OnInit {
    ...
    constructor(
      ...
      this.editUserForm = this.fb.group({
        ...
        secondname: ['', [Validators.required]],
        email: ['', [Validators.required, Validators.email]],
        password: [''], // Sera requis seulement si changePassword est true
        telephone: [''],
        profession: [''],
        role: ['USER', [Validators.required]],
        sexe: [''],
...
// Modifier la méthode openEditModal pour mieux gérer l'initialisation
...
// Modifier la méthode submitEditUser pour utiliser les bonnes valeurs
submitEditUser(): void {
  ...
  const updateData: UpdateUser = {
    ...
    // Utiliser les IDs sélectionnés plutôt que les valeurs du formulaire
    departement: this.editSelectedDepartementId?.toString() || '',
    fb: formData.fb,
    localiteResidence: formData.localiteResidence,
    region: this.editSelectedRegionId?.toString() || '',
  ...
  this.userService.updateUser(formData.id, updateData).subscribe({
    next: (updatedUser) => {
