...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, RouterModule, FooterComponent, LearnComponent, OurtakeComponent, LatestComponent, OpportunitesComponent, VideoComponent, LeafletComponent],
